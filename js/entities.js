...
Player.prototype.update = function() {
    ...
    if (game.playground.layout[layout_index] !== "w" && game.playground.layout[layout_index] !== "k") { //checking for  water or star position ) => win
        if (game.playground.layout[layout_index] !== "r")  {                // checking for rock position , player can't cross over
